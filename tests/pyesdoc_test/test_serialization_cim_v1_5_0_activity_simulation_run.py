...
def test_decode_from_xml_metafor_cim_v1():
    ...
    tu.assert_pyesdoc_obj(obj, '5e45202c-2b2a-11e1-a1f2-00163e9152a5', '2', '2012-02-24 16:26:48.499198')
    ...
    assert isinstance(obj.calendar, cim.v1.PerpetualPeriod) == True
    ...
    assert isinstance(obj.date_range, cim.v1.ClosedDateRange)
