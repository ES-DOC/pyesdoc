...
from pyesdoc.ontologies.cim.v1.types import Ensemble as TYPE
...
_TEST_FILE = '/v1_5_0/files/activity.ensemble.xml'


class TestDecodeCIM_v1_5_0_Ensemble(unittest.TestCase):
