...
from pyesdoc.ontologies.cim.v1_5.types.software.component_property_intent_type import ComponentPropertyIntentType
from pyesdoc.ontologies.cim.v1_5.types.shared.unit_type import UnitType
